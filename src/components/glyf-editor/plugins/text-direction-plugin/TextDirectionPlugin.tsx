...
export function TextDirectionPlugin(): null {
  ...
  if (!editor.hasNodes([DirectionNode])) {
    throw new Error('DirectionPlugin: TextDirectionNode not registered on editor');
  }
  ...
  editor.registerCommand(
    ...
    () => {
      ...
      if ($isRangeSelection(selection)) {
        $setBlocksType_experimental(selection, () => $createDirectionNode('rtl'));
      }
      return true;
    },
    COMMAND_PRIORITY_LOW
  ...
  editor.registerCommand(
    ...
    () => {
      const selection = $getSelection();
      if ($isRangeSelection(selection)) {
        $setBlocksType_experimental(selection, () => $createDirectionNode('ltr'));
      }
      return true;
    },
    COMMAND_PRIORITY_LOW
